...
public class Coloda {
    ...
    public Coloda(String name,int value){
        this.name = name;
        this.value = value;
    }
    ...
    public Coloda() {
        ...
        kartas[16] = new Karta("Шестёрка черви", 6);
        kartas[17] = new Karta("Шестёрка буби", 6);
        kartas[18] = new Karta("Шестёрка крести", 6);
        kartas[19] = new Karta("Шестёрка пики", 6);

        kartas[20] = new Karta("Семёрка черви", 7);
        kartas[21] = new Karta("Семёрка буби", 7);
        kartas[22] = new Karta("Семёрка крести", 7);
        kartas[23] = new Karta("Семёрка пики", 7);

        kartas[24] = new Karta("Восьмёрка черви", 8);
        kartas[25] = new Karta("Восьмёрка буби", 8);
        kartas[26] = new Karta("Восьмёрка крести", 8);
        kartas[27] = new Karta("Восьмёрка пики", 8);
